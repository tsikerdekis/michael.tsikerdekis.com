...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:3px; border-width:1px; border-color:#C0CCD9; border-style:solid; direction:ltr">
      <form id="sib-form" method="POST" action="https://652de57d.sibforms.com/serve/MUIEAB2VGbOCWKBa2GWBZM867_gLT4lxWOR5KYxwPIM0LkKBOct_NIYuGx-uzIGbUOQ-Vz6wUt2nillcWnhBEUWBsudUTUK5tNLF0O6c1WS-o_s_eCw0RkZlMyIuBEK4hxTBscJT-iJ6BGnAj45Wb-SGdG1mvu7Gx_LIWBE207EsK0nkkf-4UbxNTLb-ss506AmLbjCCof9DSPbO" data-type="subscription">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent; text-align:left">
            <div class="sib-text-form-block">
              <p>Access bonus book content. Stay up to date with Michail Tsikerdekis.&nbsp;</p>
            </div>
          </div>
        </div>
        <div style="padding: 8px 0;">
        ...
        <div style="padding: 8px 0;">
          <div class="g-recaptcha" data-sitekey="6LfEcGIlAAAAALYrFwYARvxREtVGTrALKKqXl9Oq" data-callback="invisibleCaptchaCallback" data-size="invisible" onclick="executeCaptcha"></div>
        </div>
        <div style="padding: 8px 0;">
